...
Enigma.prototype._encode = function(char) {
  var endval = this._r3.goThrough(this._r2.goThrough(this._r1.goThrough(char)));

  return this._r1.goThrough(
    this._r2.goThrough(this._r3.goThrough(this._reflector[endval], true), true),
    true
  );
};
